...
<p class="text-center" style="font-style:normal;line-height:19px;font-size:36px;height:56px;margin-top:23px;">Your Ads</p>
...
<div>
    <div class="container">
        ...
        foreach ($this->listings as $listing): ?>
            <div class="row">
                <div class="col-md-6" style="width:320px;margin-left:0px;">
                    <!--                    <img src=-->
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="btn-group btn-group-sm" role="group">
                            <a class="btn btn-default" role="button"
                               href="listing/edit?id=<?php echo $listing->getId(); ?>"> <i
                                        class="fa fa-edit"></i></a>
                            <button class="btn btn-default" type="button" data-target="#confirm-modal"
                                    data-toggle="modal"
                                    data-href="listing/delete?id=<?php echo $listing->getId(); ?>"><i
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" role="button"
                               href="listing/delete?id=<?php echo $listing->getId(); ?>"> Delete</a>
                        </div>
                    </div>
                </div>
            </div>
