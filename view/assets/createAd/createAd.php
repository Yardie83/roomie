    ...
    <div class="col-md-8 col-md-offset-3">
        <form class="form-horizontal custom-form" action="update" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" readonly="" name="userID" value="<?php echo AuthServiceImpl::getInstance()->getCurrentUserId(); ?>">
                    </label>
                </div>
                <div class="col-sm-4 label-column">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="street" value="<?php echo TemplateView::noHTML($listing->getStreet())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="plz" value="<?php echo TemplateView::noHTML($listing->getPlz())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="city" value="<?php echo TemplateView::noHTML($listing->getCity())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="canton" value="<?php echo TemplateView::noHTML($listing->getCanton())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="rooms" value="<?php echo TemplateView::noHTML($listing->getNumberofrooms())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="price" value="<?php echo TemplateView::noHTML($listing->getPrice())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 input-column">
                    <label>
                        <input class="form-control" type="text" required="" name="squareMeters" value="<?php echo TemplateView::noHTML($listing->getSquaremeters())?>">
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4 input-column">
                        <textarea rows="4" class="form-control" name="description" required=""><?php echo TemplateView::noHTML($listing->getDescription())?></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4 label-column">
                ...
                <div class="col-md-8 col-sm-6 input-column">
                    <div class="row">
                        <div class="col-sm-12">
                            <label>
                                <select class="form-control display-inline-block" required="">
