...
<head>
    ...
    <link rel="stylesheet" href="assets/header/header_loggedin/assets/css/untitled-1.css">
    <link rel="stylesheet" href="assets/header/header_loggedin/assets/css/untitled.css">
</head>

<body>
    <nav class="navbar navbar-default navigation-clean-search" style="height:66px;">
        <div class="container">
            <div class="navbar-header"><a class="navbar-brand navbar-link" href="#" data-bs-hover-animate="wobble" style="font-weight:bold;font-size:30px;padding:15px;height:50px;margin:6px;color:rgb(244,71,107);">Roomie </a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown" style="height:66px;"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#" style="padding: 20px;margin-top:1px;">Username <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li role="presentation"><a href="#">Create Ad</a></li>
                            <li role="presentation"><a href="#">Edit Ads</a></li>
                            <li role="presentation"><a href="#">Logout </a></li>
                        </ul>
                    </li>
                </ul>
                <ul class="nav navbar-nav" style="height:66px;">
                    <li role="presentation" style="height:60px;margin:5px 5px;"><a href="#" style="margin:15px;padding: 17px 15px 17px 15px;">Search </a></li>
                </ul>
            </div>
        </div>
    </nav>
