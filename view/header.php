...
<head>
    ...
    <link rel="stylesheet" href="assets/header/header_loggedOut/assets/css/styles.css">
...
<body>
    <div>
        <nav class="navbar navbar-default navigation-clean-search" style="height:66px;">
            <div class="container">
                <div class="navbar-header"><a class="navbar-brand navbar-link" href="#" data-bs-hover-animate="wobble" style="font-size:30px;font-weight:bold;font-style:normal;margin:6px;height:50px;color:rgb(244,71,107);">Roomie </a>
    ...
    <script src="assets/header/header_loggedOut/assets/js/jquery.min.js"></script>
    <script src="assets/header/header_loggedOut/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="assets/header/header_loggedOut/assets/js/bs-animation.js"></script>
